...
- Extent equality is asserted, not assumed. It is the one premise that turns "mirror the offset" from correct into subtly wrong, and it failed for the trailing-newline shape before the sentinel.
