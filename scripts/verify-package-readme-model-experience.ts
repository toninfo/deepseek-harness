...
const SENTENCE_MODEL_EXPERIENCE: Readonly<Record<string, SentenceContract>> = {
  ...
  'packages/client/ui-plan': { kind: 'indirect', reason: 'The control dispatches /plan command lines; dsh-plan-mode owns the model-visible policy, exit tool, and logged state.' },
