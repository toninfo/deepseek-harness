...
| `ctx.teams` | `core` | [`team`](../packages/team/team) | - | [`tool-team`](../packages/team/tool-team) | - | Owns the implicit-root roster, durable peer mailbox, shared task DAG, and continuable-child lifecycle; tool-team contributes the scoped model policy and controls. |
