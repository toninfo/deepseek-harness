...
```json
{
  ...
  "properties": {
    ...
    "objective": {
      "type": "string",
      "description": "Replacement objective for action edit; ignored for other actions."
    },
    "max_goal_rounds": {
      "type": "number",
      "description": "Replacement round cap for action edit; ignored for other actions."
    },
    "blocked_reason": {
      "type": "string",
