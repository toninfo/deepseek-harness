...
- **No TLS or origin policy** — this package does not authenticate; composing applications register guards ([`dsh-host-access-gate`](../access-gate/README.md) is the shipped shared-secret gate). A non-loopback bind still exposes the TCP listener; put a TLS reverse proxy in front of a public bind.
