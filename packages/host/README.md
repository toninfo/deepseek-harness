...
|---|---|---|
| [`webserver/`](webserver/README.md) | Browser HTTP server: named routes, upgrades, request guards, index taps, and the fallback seat | `ctx.webServer` |
| [`access-gate/`](access-gate/README.md) | Shared-secret Web UI login gate | consumes `ctx.webServer` |
