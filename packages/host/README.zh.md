...
| 包 | 职责 | ctx 键 |
|---|---|---|
| [`webserver/`](webserver/README.zh.md) | 浏览器 HTTP 服务器：具名路由、upgrade、请求拦截器、index 转换与回退席位 | `ctx.webServer` |
| [`access-gate/`](access-gate/README.zh.md) | 共享密钥 Web UI 登录门 | 消费 `ctx.webServer` |
