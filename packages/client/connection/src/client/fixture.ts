...
/**
 * The structured `web_search` result view for fixture turn 68, authored inline
...
/** The `web_fetch` result view for fixture turn 69, authored inline for the same reason. */
...
function buildAlphaLog(): SessionEvent[] {
  ...
  // Turns 68-69: the web render intent — a web_search whose result view carries
  ...
  toolTurn(68, 'web_search', '{"query":"deepseek harness architecture"}', 'Search results for deepseek harness architecture.')
  toolTurn(69, 'web_fetch', '{"url":"https://www.deepseek.com/blog/harness-architecture"}', '# Harness architecture\n\nEverything is a plugin.')

  const todoArgs = JSON.stringify({ todos: fixtureTodos })
  toolTurn(70, 'todo_write', todoArgs, 'Updated todo list: 1 pending, 1 in progress, 1 completed.')
