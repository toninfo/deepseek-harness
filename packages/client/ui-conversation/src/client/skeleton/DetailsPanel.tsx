...
import { CodeBlock, ReadBlock, TerminalBlock } from '@deepseek-ai/dsh-client-ui-primitives'
 ...
 * returned window is line-numbered and highlighted. Every other call, and a
 * running call with no card yet, keeps the flattened text form.
